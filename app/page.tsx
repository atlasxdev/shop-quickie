      ...
      <section className="py-24 sm:py-30 md:py-36">
        <MaxWidthWrapper className="max-w-lg space-y-6 md:space-y-8">
          ...
          <p className="text-balance text-xs md:text-sm -tracking-tighter">
            At Shop Quickie, we believe in the power of convenience. We&apos;re
            here to make shopping quick, simple, and stylish—because we know
            life moves fast, and so should your shopping experience. Our
            collections are crafted with care, blending quality with
            affordability. From comfortable apparel and unique jewelry pieces to
            cutting-edge electronics, we’re here to serve every need with style
            and purpose.
            <br />
            <br />
            ...
            <br />
            <br />
            We understand that shopping today is about more than just products.
            That’s why we focus on creating a personalized experience with quick
            delivery and customer care that puts you first. Shop Quickie is
            committed to bringing you what you need, when you need it—redefining
